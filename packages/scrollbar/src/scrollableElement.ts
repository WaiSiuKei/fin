...
import { INewScrollDimensions, INewScrollPosition, IScrollDimensions, IScrollPosition, Scrollable, ScrollbarVisibility, ScrollEvent } from './scrollable';
import { VerticalScrollbar } from './verticalScrollbar';
import { HorizontalScrollbar } from './horizontalScrollbar';
import { addDisposableListener, createFastDomNode, FastDomNode, IMouseWheelEvent, scheduleAtNextAnimationFrame, StandardMouseWheelEvent, IMouseEvent } from '@fin/dom';
import { IDisposable, dispose } from '@fin/disposable';
import { TimeoutTimer } from '@fin/async';
import { Emitter, Event } from '@fin/event';
import { ScrollbarHost } from './abstractScrollbar';
import { isMacintosh } from '@fin/platform';
...
export abstract class AbstractScrollableElement extends Widget {
  ...
  private _onMouseWheel(e: StandardMouseWheelEvent): void {
    ...
    if (e.deltaY || e.deltaX) {
      ...
      const shiftConvert = !isMacintosh && e.browserEvent.shiftKey;
