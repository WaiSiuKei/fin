...
import { isWindows } from '@fin/platform';
...
import { getDomNodePagePosition, FastDomNode, createFastDomNode, IMouseEvent, StandardMouseWheelEvent, GlobalMouseMoveMonitor, IStandardMouseMoveEventData, standardMouseMoveMerger } from '@fin/dom';
