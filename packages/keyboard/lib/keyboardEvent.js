...
const metaKeyMod = (platform_1.isMacintosh ? 2048 /* CtrlCmd */ : 256 /* WinCtrl */);
class StandardKeyboardEvent {
    ...
    _computeRuntimeKeybinding() {
        ...
        return new keybinding_1.SimpleKeybinding(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, key);
    }
}
